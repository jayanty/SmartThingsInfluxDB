...
//            "switchWhite","levelWhiteSlider", "levelWhiteTile",
    ...
    preferences {
        ...
        section { // AGGREGATE SWITCH/LEVEL:
            ...
            input name: "configAggregateSwitchMode", type: "enum", defaultValue: "OUT", required: false, displayDuringSetup: false,
                title: "Calaculate Aggregate 'switch' value from:\n[Default: RBGW/OUT Channels Only]",
                options: ["OUT" : "RBGW/OUT Channels Only",
                          "IN" : "IN Channels Only",
                          "ALL" : "All Channels"]

            input name: "configAggregateLevelMode", type: "enum", defaultValue: "OUT", required: false, displayDuringSetup: false,
                title: "Calaculate Aggregate 'level' value from:\n[Default: RBGW/OUT Channels Only]",
                options: ["OUT" : "RBGW/OUT Channels Only",
                          "IN" : "IN Channels Only",
                          "ALL" : "All Channels"]

            input name: "configLevelSetMode", type: "enum", defaultValue: "SCALE", required: false, displayDuringSetup: false,
        ...
        section { // CHANNEL MAPPING & THRESHOLDS:
            ...
            input name: "configCh1Mapping", type: "enum", defaultValue: "Red", required: false, displayDuringSetup: false,
            ...
            input name: "configCh1Threshold", type: "number", range: "0..100", defaultValue: "1", required: false, displayDuringSetup: false,
                title: "Channel #1: Threshold for ON (%):"

            input name: "configCh2Mapping", type: "enum", defaultValue: "Green", required: false, displayDuringSetup: false,
            ...
            input name: "configCh2Threshold", type: "number", range: "0..100", defaultValue: "1", required: false, displayDuringSetup: false,
                title: "Channel #2: Threshold for ON (%):"

            input name: "configCh3Mapping", type: "enum", defaultValue: "Blue", required: false, displayDuringSetup: false,
            ...
            input name: "configCh3Threshold", type: "number", range: "0..100", defaultValue: "1", required: false, displayDuringSetup: false,
                title: "Channel #3: Threshold for ON (%):"

            input name: "configCh4Mapping", type: "enum", defaultValue: "White", required: false, displayDuringSetup: false,
            ...
            input name: "configCh4Threshold", type: "number", range: "0..100", defaultValue: "1", required: false, displayDuringSetup: false,
        ...
        section { // PHYSICAL DEVICE PARAMETERS:
            ...
            input name: "configParam01", type: "enum", defaultValue: "255", required: false, displayDuringSetup: false,
            ...
            input name: "configParam06", type: "enum", defaultValue: "0", required: false, displayDuringSetup: false,
            ...
            input name: "configParam08", type: "enum", defaultValue: "0", required: false, displayDuringSetup: false,
                title: "#8: IN/OUT: Outputs state change mode:\n[Default: 0: MODE1]",
                options: ["0" : "0: MODE1",
                          "1" : "1: MODE2"]

            input name: "configParam09", type: "number", range: "1..255", defaultValue: "1", required: false, displayDuringSetup: false,
                title: "#9: MODE1: Step value:\n[Default: 1]"

            input name: "configParam10", type: "number", range: "0..60000", defaultValue: "10", required: false, displayDuringSetup: false,
                title: "#10: MODE1: Time between steps:\n[Default: 10ms]\n" +
                       " - 0: immediate change"

            input name: "configParam11", type: "number", range: "0..255", defaultValue: "67", required: false, displayDuringSetup: false,
            ...
            input name: "configParam12", type: "number", range: "3..255", defaultValue: "255", required: false, displayDuringSetup: false,
                title: "#12: Maximum brightening level:\n[Default: 255]"

            input name: "configParam13", type: "number", range: "0..254", defaultValue: "2", required: false, displayDuringSetup: false,
            ...
            input name: "configParam14_1", type: "enum", defaultValue: "1", required: false, displayDuringSetup: false,
            ...
            input name: "configParam14_2", type: "enum", defaultValue: "1", required: false, displayDuringSetup: false,
                title: "CHANNEL 2:\n[Default: 1: RGBW - MOMENTARY (NORMAL MODE)]",
                options: ["1" : "1: RGBW - MOMENTARY (NORMAL MODE)",
                          "2" : "2: RGBW - MOMENTARY (BRIGHTNESS MODE)",
                          "3" : "3: RGBW - MOMENTARY (RAINBOW MODE)",
            ...
            input name: "configParam14_3", type: "enum", defaultValue: "1", required: false, displayDuringSetup: false,
                title: "CHANNEL 3:\n[Default: 1: RGBW - MOMENTARY (NORMAL MODE)]",
                options: ["1" : "1: RGBW - MOMENTARY (NORMAL MODE)",
                          "2" : "2: RGBW - MOMENTARY (BRIGHTNESS MODE)",
                          "3" : "3: RGBW - MOMENTARY (RAINBOW MODE)",
            ...
            input name: "configParam14_4", type: "enum", defaultValue: "1", required: false, displayDuringSetup: false,
                title: "CHANNEL 4:\n[Default: 1: RGBW - MOMENTARY (NORMAL MODE)]",
                options: ["1" : "1: RGBW - MOMENTARY (NORMAL MODE)",
                          "2" : "2: RGBW - MOMENTARY (BRIGHTNESS MODE)",
                          "3" : "3: RGBW - MOMENTARY (RAINBOW MODE)",
            ...
            input name: "configParam16", type: "enum", defaultValue: "1", required: false, displayDuringSetup: false,
                title: "#16: Memorise device status at power cut:\n[Default: 1: MEMORISE STATUS]",
                options: ["0" : "0: DO NOT MEMORISE STATUS",
                          "1" : "1: MEMORISE STATUS"]

            input name: "configParam30", type: "enum", defaultValue: "0", required: false, displayDuringSetup: false,
            ...
            input name: "configParam38", type: "number", range: "1..10", defaultValue: "10", required: false, displayDuringSetup: false,
                title: "#38: Alarm sequence program:\n[Default: 10]"

            input name: "configParam39", type: "number", range: "1..65534", defaultValue: "600", required: false, displayDuringSetup: false,
                title: "#39: Active PROGRAM alarm time:\n[Default: 600s]"

            input name: "configParam42", type: "enum", defaultValue: "0", required: false, displayDuringSetup: false,
            ...
            input name: "configParam43", type: "number", range: "1..100", defaultValue: "5", required: false, displayDuringSetup: false,
                title: "#43: Reporting 0-10v analog inputs change threshold:\n[Default: 5 = 0.5V]"

            input name: "configParam44", type: "number", range: "0..65534", defaultValue: "30", required: false, displayDuringSetup: false,
                title: "#44: Power load reporting frequency:\n[Default: 30s]\n" +
                       " - 0: reports are not sent\n" +
                       " - 1-65534: time between reports (s)"

            input name: "configParam45", type: "number", range: "0..254", defaultValue: "10", required: false, displayDuringSetup: false,
                title: "#45: Reporting changes in energy:\n[Default: 10 = 0.1kWh]\n" +
                       " - 0: reports are not sent\n" +
                       " - 1-254: 0.01kWh - 2.54kWh"

            input name: "configParam71", type: "enum", defaultValue: "1", required: false, displayDuringSetup: false,
                title: "#71: Response to BRIGHTNESS set to 0%:\n[Default: 1]",
                options: ["0" : "0: Illumination colour set to white",
                          "1" : "1: Last set colour is memorised"]

            input name: "configParam72", type: "number", range: "1..10", defaultValue: "1", required: false, displayDuringSetup: false,
                title: "#72: Start predefined (RGBW) program:\n[Default: 1]\n" +
                       " - 1-10: animation program number"

            input name: "configParam73", type: "enum", defaultValue: "0", required: false, displayDuringSetup: false,
